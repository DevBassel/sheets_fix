...
import { writeRowsToCSV } from "./writeRowsToCSV";
import { writeRowsToNewExcel } from "./writeRowsToNewExcel";
import { writeJsonFile } from "./writeJsonFile";

export async function handelStuSheets(filePath: string, outFileName: string) {
  try {
        ...
        row.eachCell((cell, colNumber) => {
          ...
          switch (colNumber) {
            ...
            case 3:
              ...
              if (checkValue(cellVal)) {
                if (/(غرب|زفت|مركز طنطا)/gi.test(cellVal)) {
            ...
            case 4:
              ...
              if (checkValue(cellVal)) {
                ...
                if (/(غرب طن|محلة مرحوم)/gi.test(cellVal)) {
            ...
            case 11:
              ...
              if (checkValue(cellVal)) {
                ...
                if (/(راب|4|ربع|رايع)/gi.test(cellVal)) {
                  cls4.add(cellVal);
    ...
    console.log("TCL: openExcelFile -> error", error);
  }
}
